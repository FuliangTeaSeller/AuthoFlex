...
public class AfBeanInject {
    ...
    public void setAfPermissionHandler(AfPermissionHanlder afPermissionHanlder) {
        if (afPermissionHanlder != null) {
            AfManager.setAfPermissionHanlder(afPermissionHanlder);
        }
    }
}
